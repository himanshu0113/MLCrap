...
class NN(object):
    ...
    def update_batch(self, mini_batch, eta):
        ...
        #print 'delta W', len(new_w), self.weights
        #print 'delta B', len(new_b), self.biases
...
#net.run(training_data=zip(pixel, label), test_data=zip(test_pixel, test_label), eta=0.003, epochs=40)
#clf = net
